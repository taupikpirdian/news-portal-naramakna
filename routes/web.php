...
Route::get('/api/v1/search', [\App\Http\Controllers\HomeController::class , 'searchPosts'])->name('api.search');
// index-berita.html
...
// artikel.html
Route::get('/artikel/{slug}', [\App\Http\Controllers\HomeController::class , 'detail'])->name('detail');
// bantu.html
