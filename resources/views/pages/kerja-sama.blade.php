    ...
    <div class="rounded-3xl bg-gradient-to-r from-orange-500 to-orange-600 text-white p-8 sm:p-10 shadow-xl">
        <div class="text-center">
            ...
            <div class="mt-6 flex justify-center gap-3">
                <a href="https://api.whatsapp.com/send/?phone=628131447979&text&type=phone_number&app_absent=0" target="_blank" rel="noopener noreferrer" class="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-white/80 text-white no-underline hover:bg-white/10">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
                ...
                <a href="mailto:marketingnaramakna@gmail.com" class="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-white/80 text-white no-underline hover:bg-white/10">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
