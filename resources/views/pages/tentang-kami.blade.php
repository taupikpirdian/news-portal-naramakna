    ...
    <div class="grid md:grid-cols-3 gap-6">
        <div class="rounded-2xl border border-gray-200 p-6 bg-white">
            <div class="flex items-center gap-4">
                ...
                <div>
                    <div class="text-sm font-semibold text-gray-900">Kaila Hasya Apriliyanti</div>
                    <div class="text-xs text-gray-600">Social Media Specialist</div>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="grid md:grid-cols-3 gap-6">
        ...
        <div class="rounded-2xl border border-gray-200 p-6 bg-white">
            <div class="flex items-center gap-4">
                ...
                <div>
                    <div class="text-sm font-semibold text-gray-900">Aziz Munan Prinandi</div>
                    <div class="text-xs text-gray-600">Pemasaran dan Kerja Sama</div>
                </div>
            </div>
        </div>
    ...
    <div class="grid md:grid-cols-3 gap-6">
        ...
        <div class="rounded-2xl border border-gray-200 p-6 bg-white hover:shadow-lg transition-all">
            ...
            <div class="text-xs text-gray-700 space-y-1 leading-relaxed">
                <div>Tlp./WA: <a href="https://wa.me/628131447997" target="_blank" rel="noopener noreferrer" class="no-underline text-gray-700 hover:text-yellow-450">0813-1447-997</a></div>
    ...
    <div class="rounded-3xl bg-gradient-to-r from-orange-500 to-orange-600 text-white p-8 sm:p-10 shadow-xl">
        <div class="text-center">
            ...
            <div class="mt-6 flex justify-center gap-3">
                ...
                <a href="https://api.whatsapp.com/send/?phone=628131447997&text&type=phone_number&app_absent=0" target="_blank" rel="noopener noreferrer" class="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-white/80 text-white no-underline hover:bg-white/10">
